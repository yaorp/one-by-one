...
public class DesUtil {
    ...
    // 生产环境
//     public static String KEY = "gkewnmfg";
    ...
    private static ConcurrentHashMap<String, DesUtil> instanceMap = new ConcurrentHashMap();
    ...
    private synchronized static DesUtil getNewInstance() throws Exception {
        if (instanceMap.containsKey(KEY)) {
            return instanceMap.get(KEY);
        }
    ...
    private static void runMutiThreadTest() {
        for (int i = 0; i < 1; i++) {
    ...
    public static void main(String[] args) throws Exception {
        DesUtil des = DesUtil.getInstance();
        String aaa = "96f6a44a998c6d8fa1e7eb92feff3725504e743034cc240f";
        String decrypt = des.decrypt(aaa);
        // 生产环境
        System.out.println(des.decrypt(
                "96f6a44a998c6d8fa1e7eb92feff3725504e743034cc240f"));
